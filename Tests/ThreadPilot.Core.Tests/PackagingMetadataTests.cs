namespace ThreadPilot.Core.Tests
{
    ...
    {
        private const string ReleaseVersion = "1.7.5";
        private const string ReleaseAssemblyVersion = "1.7.5.0";
        ...
        [GeneratedRegex("#define MyAppVersion \"1\\.7\\.5\"", RegexOptions.CultureInvariant)]
